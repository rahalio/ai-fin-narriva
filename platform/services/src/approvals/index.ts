/**
 * Approvals Services - Application Layer Export
 *
...
/**
 * Approvals Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for approvals domain.
 */
