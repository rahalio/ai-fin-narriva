/**
 * Snapshots Services - Application Layer Export
 *
...
/**
 * Snapshots Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for snapshots domain.
 */
