/**
 * Deliveries Services - Application Layer Export
 *
...
/**
 * Deliveries Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for deliveries domain.
 */
