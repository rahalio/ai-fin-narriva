 ...
 *
 * @returns The core table name (e.g., "narriva-core-dev")
 ...
 *
 * @returns The base table name (e.g., "narriva-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "narriva-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "narriva-app-realtime-dev")
